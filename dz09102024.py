...
option = input('Давайте рассчитаем значение длины стороны треугольника по теореме косинусов!\n'
               'Начинаем?\n'
               'Чтобы перейти к выполнению программы, введите "Y"\n'
               'Чтобы завершить выполнение программы, введите "N"\n').lower()
